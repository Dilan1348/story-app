    ...
    return `
      <section class="home-page-container">
        ...
        <div class="new-story-container">
          ...
          <div class="new-story-button"><a href="#/stories" class="new-story__link"><i class="fas fa-save"></i> Story Tersimpan</a></div>
          <div class="new-story-button"><a href="#/stories" class="new-story__link"><i class="fas fa-plus"></i> Buat Story</a></div>
          </div>
        </div>
